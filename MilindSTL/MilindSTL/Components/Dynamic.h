...
private:
	...
	// Minimum vector size in Bytes (Resizes are also in same Block Size) , bigger blocks are faster
	#define MEM_BLOCK 10
	T* m_Data = nullptr;
	size_t Top = 0;
...
public:
	...
	// Standard push_back , if enough capacity avaialble , then write , else resize and then write
